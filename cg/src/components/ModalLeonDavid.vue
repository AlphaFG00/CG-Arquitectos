<template>
    <div class="Modal-LeonDavid">
      <div class="modal" id="myModal" ref="myModal">
        <div class="contenido">
            <span class="cerrar" ref="myClose">&times;</span>
            <h2>{{proyectTitle}}</h2>
            <b-img class="proyecto-imagen" :src="require(`../assets/imagenproyectos/5.jpg`)" alt="Imagen-Proyecto-LeonDavid"></b-img>
                  ...
                  <div id="slider">
                    <div class="contenido2">
                      <div class="slide">
                        ...
                        <p>Diseño y construcción de casa habitación.</p>
                      </div>
                      <div class="slide">
