<template>
    <div class="Modal-Apaches">
      <div class="modal" id="myModal" ref="myModal">
        <div class="contenido">
            <span class="cerrar" ref="myClose">&times;</span>
            <h2>{{proyectTitle}}</h2>
            <b-img class="proyecto-imagen" :src="require(`../assets/imagenproyectos/2.jpg`)" alt="Imagen-Proyecto-Apaches"></b-img>
                  ...
                  <div id="slider">
                    <div class="contenido2">
                      <div class="slide">
                        ...
                        <p>Desarrollo Inmobiliario para un Fraccionamiento de 9 casas de nivel residencial alto, incluyendo Diseño y construcción, urbanización y comercialización.</p>
                      </div>
                      <div class="slide">
                      ...
                      <div class="slide">
                        ...
                        <p> 9 casas de 250 – 300 metros cuadrados</p>
                      </div>
                    </div>
                  </div>
                <!--Desplazador (Fin)-->
